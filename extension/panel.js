...
function CheckboxIcon({
  ...
  return /*#__PURE__*/react.createElement("span", {
    className: classnames_default()('menu-item__checkbox', {
...
function MenuItem({
  ...
  const handleClick = e => {
    if (hasChildren) {
      ...
      chrome.devtools.inspectedWindow.eval(`document.querySelector('#${item.id} a').click()`);
    }
  };
  return /*#__PURE__*/react.createElement("li", {
    className: classnames_default()('menu-item', {
  ...
  }, item.text)), hasChildren && /*#__PURE__*/react.createElement("span", {
    className: "menu-item__arrow"
  }, "\u25BE")), hasChildren && isOpen && /*#__PURE__*/react.createElement("ul", {
    className: "menu-item__submenu"
  }, item.children.map((child, index) => /*#__PURE__*/react.createElement(MenuItem, {
    key: child.id || index,
    item: child
  }))));
}
;// ./src/components/UtilsList.js


function UtilsList() {
  const [utils, setUtils] = (0,react.useState)([]);
  (0,react.useEffect)(() => {
  ...
  if (utils.length === 0) {
    return /*#__PURE__*/react.createElement("div", {
      className: "utils-list utils-list--empty"
    }, "No utilities found.");
  }
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "utils-list__items"
  }, utils.map((item, index) => /*#__PURE__*/react.createElement(MenuItem, {
    key: item.id || index,
    item: item
  }))));
}
...
function LogsTable() {
  const [logsTable, setLogsTable] = (0,react.useState)('');
  const [isDarkTheme, setIsDarkTheme] = (0,react.useState)(false);
  const [wpformsAdmin, setWpformsAdmin] = (0,react.useState)(null);
  const [logDetails, setLogDetails] = (0,react.useState)(null);
  ...
  const handleTableClick = e => {
    ...
    if (!wpformsAdmin || !wpformsAdmin.nonce) {
      console.log('No wpformsAdmin data:', {
        wpformsAdmin
      });
      return;
    }
  ...
  if (!logsTable || logsTable.length === 0) {
    return /*#__PURE__*/react.createElement("div", {
      className: classnames_default()('logs-table logs-table--empty', {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ref: tableRef,
    className: classnames_default()('logs-table', {
      'dark-theme': isDarkTheme
    }),
    onClick: handleTableClick
  }, /*#__PURE__*/react.createElement("div", {
    className: "logs-table__content",
...
function ErrorLog({
    ...
    ws.current.onclose = () => {
      ...
      if (!checkInterval.current) {
        checkInterval.current = setInterval(() => {
          fetch(`http://localhost:${WS_PORT}/health`).then(response => {
            if (response.ok) {
              initWebSocket();
            }
          }).catch(() => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "error-log__content",
    ref: contentRef
  }, logLines.map((line, index) => /*#__PURE__*/react.createElement("pre", {
    key: index,
    className: classnames_default()('log-line', {
...
function EntriesTable({
  ...
  const [entriesTable, setEntriesTable] = (0,react.useState)('');
  const [isDarkTheme, setIsDarkTheme] = (0,react.useState)(false);
  const tableRef = (0,react.useRef)(null);
  ...
  (0,react.useEffect)(() => {
    ...
    const setupConfirmationMonitoring = () => {
      ...
      const script = `
			...
			`;
      chrome.devtools.inspectedWindow.eval(script, (result, isException) => {
        console.log('Script evaluation result:', {
          result,
          isException
        });
      });
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: classnames_default()('wpforms-entries-table-wrapper', {
      'dark-theme': isDarkTheme
    })
  }, /*#__PURE__*/react.createElement("div", {
    ref: tableRef,
    className: "wpforms-entries-table"
  }));
}
;// ./src/utils/meta-data.js
/**
...
function FormPanel({
  ...
  const [activeMenuItem, setActiveMenuItem] = (0,react.useState)('form_data');
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "menu"
  }, menuItems.map(item => /*#__PURE__*/react.createElement("li", {
    key: item.id,
 ...
 */
function TabPanel() {
  const [activeTab, setActiveTab] = (0,react.useState)('utils');
  const [isDarkTheme, setIsDarkTheme] = (0,react.useState)(false);
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: classnames_default()('tab-panel', {
      'dark-theme': isDarkTheme
    })
  }, /*#__PURE__*/react.createElement("div", {
    className: "tab-panel__header"
  }, tabs.map(tab => /*#__PURE__*/react.createElement("button", {
    key: tab.id,
    className: classnames_default()('tab-panel__tab', {
...
root.render(/*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(TabPanel, null)));
})();
